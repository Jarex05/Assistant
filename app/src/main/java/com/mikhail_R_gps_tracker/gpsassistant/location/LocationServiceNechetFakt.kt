...
class LocationServiceNechetFakt : Service() {
    ...
    private var isDebagNechetFakt = false
...
//        return soundPool.load(afd.fileDescriptor, 1000, 1000000000000, 1)
    ...
    private val locCallbackNechetFakt = object : LocationCallback(){
        override fun onLocationResult(lResultNechetFakt: LocationResult) {
            ...
            val currentLocationNechetFakt = lResultNechetFakt.lastLocation
            if (currentLocationNechetFakt != null){
//                lastLocationNechetFakt != null &&
                getLatLongKmNechetFakt()

                val mLoc = Location("").apply {
                    latitude = currentLocationNechetFakt.latitude
                    longitude = currentLocationNechetFakt.longitude
                }
...
//                        myDbManagerBrake.closeDb()
                ...
                CoroutineScope(Dispatchers.Main).launch {
                    ...
                    for (item in dataListLimitations){
                        ...
                        if (currentLocationNechetFakt.speed * 3.6 >= 15 && distanceNechet <= faktNachKmNechet + 549 && distanceNechet >= faktNachKmNechet + 501 && item.speedNechet == 15 && isLimitationsChet400m15){
                            playSound(voiceprev)
                        ...
                        if (currentLocationNechetFakt.speed * 3.6 >= 25 && distanceNechet <= faktNachKmNechet + 549 && distanceNechet >= faktNachKmNechet + 501 && item.speedNechet == 25 && isLimitationsChet400m25){
                            playSound(voiceprev)
                        ...
                        if (currentLocationNechetFakt.speed * 3.6 >= 40 && distanceNechet <= faktNachKmNechet + 549 && distanceNechet >= faktNachKmNechet + 501 && item.speedNechet == 40 && isLimitationsChet400m40){
                            playSound(voiceprev)
                        ...
                        if (currentLocationNechetFakt.speed * 3.6 >= 50 && distanceNechet <= faktNachKmNechet + 549 && distanceNechet >= faktNachKmNechet + 501 && item.speedNechet == 50 && isLimitationsChet400m50){
                            playSound(voiceprev)
                        ...
                        if (currentLocationNechetFakt.speed * 3.6 >= 55 && distanceNechet <= faktNachKmNechet + 549 && distanceNechet >= faktNachKmNechet + 501 && item.speedNechet == 55 && isLimitationsChet400m55){
                            playSound(voiceprev)
                        ...
                        if (currentLocationNechetFakt.speed * 3.6 >= 60 && distanceNechet <= faktNachKmNechet + 549 && distanceNechet >= faktNachKmNechet + 501 && item.speedNechet == 60 && isLimitationsChet400m60){
                            playSound(voiceprev)
                        ...
                        if (currentLocationNechetFakt.speed * 3.6 >= 65 && distanceNechet <= faktNachKmNechet + 549 && distanceNechet >= faktNachKmNechet + 501 && item.speedNechet == 65 && isLimitationsChet400m65){
                            playSound(voiceprev)
                        ...
                        if (currentLocationNechetFakt.speed * 3.6 >= 70 && distanceNechet <= faktNachKmNechet + 549 && distanceNechet >= faktNachKmNechet + 501 && item.speedNechet == 70 && isLimitationsChet400m70){
                            playSound(voiceprev)
                        ...
                        if (currentLocationNechetFakt.speed * 3.6 >= 75 && distanceNechet <= faktNachKmNechet + 549 && distanceNechet >= faktNachKmNechet + 501 && item.speedNechet == 75 && isLimitationsChet400m75){
                            playSound(voiceprev)
                        ...
                        if (distanceNechet <= faktNachKmNechet && distanceNechet >= faktEndKmNechet - sumCalculateUslNechet && item.speedNechet == 15){
                            ...
                            if (currentLocationNechetFakt.speed * 3.6 >= 14 && distanceNechet <= faktNachKmNechet && distanceNechet >= faktNachKmNechet - sumDistance && item.speedNechet == 15 && isOgr){
                                playSound(ogr15)
                                isOgr = false
                            }
                        }
                        ...
                        if (distanceNechet <= faktNachKmNechet && distanceNechet >= faktEndKmNechet - sumCalculateUslNechet && item.speedNechet == 25){
                            val sumDistance = (faktNachKmNechet - faktEndKmNechet) + sumCalculateUslNechet
                            if (currentLocationNechetFakt.speed * 3.6 >= 24 && distanceNechet <= faktNachKmNechet && distanceNechet >= faktNachKmNechet - sumDistance && item.speedNechet == 25 && isOgr){
                                playSound(ogr25)
                                isOgr = false
                            }
                        }
                        ...
                        if (distanceNechet <= faktNachKmNechet && distanceNechet >= faktEndKmNechet - sumCalculateUslNechet && item.speedNechet == 40){
                            val sumDistance = (faktNachKmNechet - faktEndKmNechet) + sumCalculateUslNechet
                            if (currentLocationNechetFakt.speed * 3.6 >= 39 && distanceNechet <= faktNachKmNechet && distanceNechet >= faktNachKmNechet - sumDistance && item.speedNechet == 40 && isOgr){
                                playSound(ogr40)
                                isOgr = false
                            }
                        }
                        ...
                        if (distanceNechet <= faktNachKmNechet && distanceNechet >= faktEndKmNechet - sumCalculateUslNechet && item.speedNechet == 50){
                            val sumDistance = (faktNachKmNechet - faktEndKmNechet) + sumCalculateUslNechet
                            if (currentLocationNechetFakt.speed * 3.6 >= 49 && distanceNechet <= faktNachKmNechet && distanceNechet >= faktNachKmNechet - sumDistance && item.speedNechet == 50 && isOgr){
                                playSound(ogr50)
                                isOgr = false
                            }
                        }
                        ...
                        if (distanceNechet <= faktNachKmNechet && distanceNechet >= faktEndKmNechet - sumCalculateUslNechet && item.speedNechet == 55){
                            val sumDistance = (faktNachKmNechet - faktEndKmNechet) + sumCalculateUslNechet
                            if (currentLocationNechetFakt.speed * 3.6 >= 54 && distanceNechet <= faktNachKmNechet && distanceNechet >= faktNachKmNechet - sumDistance && item.speedNechet == 55 && isOgr){
                                playSound(ogr55)
                                isOgr = false
                            }
                        }
                        ...
                        if (distanceNechet <= faktNachKmNechet && distanceNechet >= faktEndKmNechet - sumCalculateUslNechet && item.speedNechet == 60){
                            val sumDistance = (faktNachKmNechet - faktEndKmNechet) + sumCalculateUslNechet
                            if (currentLocationNechetFakt.speed * 3.6 >= 59 && distanceNechet <= faktNachKmNechet && distanceNechet >= faktNachKmNechet - sumDistance && item.speedNechet == 60 && isOgr){
                                playSound(ogr60)
                                isOgr = false
                            }
                        }
                        ...
                        if (distanceNechet <= faktNachKmNechet && distanceNechet >= faktEndKmNechet - sumCalculateUslNechet && item.speedNechet == 65){
                            val sumDistance = (faktNachKmNechet - faktEndKmNechet) + sumCalculateUslNechet
                            if (currentLocationNechetFakt.speed * 3.6 >= 64 && distanceNechet <= faktNachKmNechet && distanceNechet >= faktNachKmNechet - sumDistance && item.speedNechet == 65 && isOgr){
                                playSound(ogr65)
                                isOgr = false
                            }
                        }
                        ...
                        if (distanceNechet <= faktNachKmNechet && distanceNechet >= faktEndKmNechet - sumCalculateUslNechet && item.speedNechet == 70){
                            val sumDistance = (faktNachKmNechet - faktEndKmNechet) + sumCalculateUslNechet
                            if (currentLocationNechetFakt.speed * 3.6 >= 69 && distanceNechet <= faktNachKmNechet && distanceNechet >= faktNachKmNechet - sumDistance && item.speedNechet == 70 && isOgr){
                                playSound(ogr70)
                                isOgr = false
                            }
                        }
                        ...
                        if (distanceNechet <= faktNachKmNechet && distanceNechet >= faktEndKmNechet - sumCalculateUslNechet && item.speedNechet == 75){
                            val sumDistance = (faktNachKmNechet - faktEndKmNechet) + sumCalculateUslNechet
                            if (currentLocationNechetFakt.speed * 3.6 >= 74 && distanceNechet <= faktNachKmNechet && distanceNechet >= faktNachKmNechet - sumDistance && item.speedNechet == 75 && isOgr){
                                playSound(ogr75)
                                isOgr = false
                            }
                        }
...
//                        myDbManagerLimitations.closeDb()
                ...
                val locModelNechetFakt = LocationModelNechetFakt(
                    currentLocationNechetFakt.speed,
                    distanceNechet,
...
//            lastLocationNechetFakt = currentLocationNechetFakt
        }
    }
    ...
    companion object{
        const val LOC_MODEL_INTENT_NECHET_FAKT = "loc_model_intent_nechet_fakt"
        const val CHANNEL_ID_NECHET_FAKT = "channel_id_nechet_fakt_1"
