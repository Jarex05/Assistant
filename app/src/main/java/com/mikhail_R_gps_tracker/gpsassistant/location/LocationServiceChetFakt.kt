...
class LocationServiceChetFakt : Service() {
    ...
    private var isDebagChetFakt = false
...
//        return soundPool.load(afd.fileDescriptor, 1000, 1000, 1)
    ...
    private val locCallbackChetFakt = object : LocationCallback(){
        override fun onLocationResult(lResultChetFakt: LocationResult) {
            ...
            val currentLocationChetFakt = lResultChetFakt.lastLocation
            if (currentLocationChetFakt != null){
//                lastLocationChetFakt != null &&
                getLatLongKmChetFakt()

                val mLoc = Location("").apply {
                    latitude = currentLocationChetFakt.latitude
                    longitude = currentLocationChetFakt.longitude
                }
...
//                            }
                        ...
                        if (currentLocationChetFakt.speed * 3.6 >= 15 && distanceChet >= faktNachKmChet - 549 && distanceChet <= faktNachKmChet - 501 && item.speedChet == 15 && isLimitationsChet400m15){
                            playSound(voiceprev)
                        ...
                        if (currentLocationChetFakt.speed * 3.6 >= 25 && distanceChet >= faktNachKmChet - 549 && distanceChet <= faktNachKmChet - 501 && item.speedChet == 25 && isLimitationsChet400m25){
                            playSound(voiceprev)
                        ...
                        if (currentLocationChetFakt.speed * 3.6 >= 40 && distanceChet >= faktNachKmChet - 549 && distanceChet <= faktNachKmChet - 501 && item.speedChet == 40 && isLimitationsChet400m40){
                            playSound(voiceprev)
                        ...
                        if (currentLocationChetFakt.speed * 3.6 >= 50 && distanceChet >= faktNachKmChet - 549 && distanceChet <= faktNachKmChet - 501 && item.speedChet == 50 && isLimitationsChet400m50){
                            playSound(voiceprev)
                        ...
                        if (currentLocationChetFakt.speed * 3.6 >= 55 && distanceChet >= faktNachKmChet - 549 && distanceChet <= faktNachKmChet - 501 && item.speedChet == 55 && isLimitationsChet400m55){
                            playSound(voiceprev)
                        ...
                        if (currentLocationChetFakt.speed * 3.6 >= 60 && distanceChet >= faktNachKmChet - 549 && distanceChet <= faktNachKmChet - 501 && item.speedChet == 60 && isLimitationsChet400m60){
                            playSound(voiceprev)
                        ...
                        if (currentLocationChetFakt.speed * 3.6 >= 65 && distanceChet >= faktNachKmChet - 549 && distanceChet <= faktNachKmChet - 501 && item.speedChet == 65 && isLimitationsChet400m65){
                            playSound(voiceprev)
                        ...
                        if (currentLocationChetFakt.speed * 3.6 >= 70 && distanceChet >= faktNachKmChet - 549 && distanceChet <= faktNachKmChet - 501 && item.speedChet == 70 && isLimitationsChet400m70){
                            playSound(voiceprev)
                        ...
                        if (currentLocationChetFakt.speed * 3.6 >= 75 && distanceChet >= faktNachKmChet - 549 && distanceChet <= faktNachKmChet - 501 && item.speedChet == 75 && isLimitationsChet400m75){
                            playSound(voiceprev)
                        ...
                        if (distanceChet >= faktNachKmChet && distanceChet <= faktEndKmChet + sumCalculateUslChet && item.speedChet == 15){
                            ...
                            if (currentLocationChetFakt.speed * 3.6 >= 14 && distanceChet >= faktNachKmChet && distanceChet <= faktNachKmChet + sumDistance && item.speedChet == 15 && isOgr){
                                playSound(ogr15)
                                isOgr = false
                            }
                        }
                        ...
                        if (distanceChet >= faktNachKmChet && distanceChet <= faktEndKmChet + sumCalculateUslChet && item.speedChet == 25){
                            val sumDistance = (faktEndKmChet - faktNachKmChet) + sumCalculateUslChet
                            if (currentLocationChetFakt.speed * 3.6 >= 24 && distanceChet >= faktNachKmChet && distanceChet <= faktNachKmChet + sumDistance && item.speedChet == 25 && isOgr){
                                playSound(ogr25)
                                isOgr = false
                            }
                        }
                        ...
                        if (distanceChet >= faktNachKmChet && distanceChet <= faktEndKmChet + sumCalculateUslChet && item.speedChet == 40){
                            val sumDistance = (faktEndKmChet - faktNachKmChet) + sumCalculateUslChet
                            if (currentLocationChetFakt.speed * 3.6 >= 39 && distanceChet >= faktNachKmChet && distanceChet <= faktNachKmChet + sumDistance && item.speedChet == 40 && isOgr){
                                playSound(ogr40)
                                isOgr = false
                            }
                        }
                        ...
                        if (distanceChet >= faktNachKmChet && distanceChet <= faktEndKmChet + sumCalculateUslChet && item.speedChet == 50){
                            val sumDistance = (faktEndKmChet - faktNachKmChet) + sumCalculateUslChet
                            if (currentLocationChetFakt.speed * 3.6 >= 49 && distanceChet >= faktNachKmChet && distanceChet <= faktNachKmChet + sumDistance && item.speedChet == 50 && isOgr){
                                playSound(ogr50)
                                isOgr = false
                            }
                        }
                        ...
                        if (distanceChet >= faktNachKmChet && distanceChet <= faktEndKmChet + sumCalculateUslChet && item.speedChet == 55){
                            val sumDistance = (faktEndKmChet - faktNachKmChet) + sumCalculateUslChet
                            if (currentLocationChetFakt.speed * 3.6 >= 54 && distanceChet >= faktNachKmChet && distanceChet <= faktNachKmChet + sumDistance && item.speedChet == 55 && isOgr){
                                playSound(ogr55)
                                isOgr = false
                            }
                        }
                        ...
                        if (distanceChet >= faktNachKmChet && distanceChet <= faktEndKmChet + sumCalculateUslChet && item.speedChet == 60){
                            val sumDistance = (faktEndKmChet - faktNachKmChet) + sumCalculateUslChet
                            if (currentLocationChetFakt.speed * 3.6 >= 59 && distanceChet >= faktNachKmChet && distanceChet <= faktNachKmChet + sumDistance && item.speedChet == 60 && isOgr){
                                playSound(ogr60)
                                isOgr = false
                            }
                        }
                        ...
                        if (distanceChet >= faktNachKmChet && distanceChet <= faktEndKmChet + sumCalculateUslChet && item.speedChet == 65){
                            val sumDistance = (faktEndKmChet - faktNachKmChet) + sumCalculateUslChet
                            if (currentLocationChetFakt.speed * 3.6 >= 64 && distanceChet >= faktNachKmChet && distanceChet <= faktNachKmChet + sumDistance && item.speedChet == 65 && isOgr){
                                playSound(ogr65)
                                isOgr = false
                            }
                        }
                        ...
                        if (distanceChet >= faktNachKmChet && distanceChet <= faktEndKmChet + sumCalculateUslChet && item.speedChet == 70){
                            val sumDistance = (faktEndKmChet - faktNachKmChet) + sumCalculateUslChet
                            if (currentLocationChetFakt.speed * 3.6 >= 69 && distanceChet >= faktNachKmChet && distanceChet <= faktNachKmChet + sumDistance && item.speedChet == 70 && isOgr){
                                playSound(ogr70)
                                isOgr = false
                            }
                        }
                        ...
                        if (distanceChet >= faktNachKmChet && distanceChet <= faktEndKmChet + sumCalculateUslChet && item.speedChet == 75){
                            val sumDistance = (faktEndKmChet - faktNachKmChet) + sumCalculateUslChet
                            if (currentLocationChetFakt.speed * 3.6 >= 74 && distanceChet >= faktNachKmChet && distanceChet <= faktNachKmChet + sumDistance && item.speedChet == 75 && isOgr){
                                playSound(ogr75)
                                isOgr = false
                            }
                        }
...
//            lastLocationChetFakt = currentLocationChetFakt
        }
    }
    ...
    companion object{
        const val LOC_MODEL_INTENT_CHET_FAKT = "loc_model_intent_chet_fakt"
        const val CHANNEL_ID_CHET_FAKT = "channel_id_chet_fakt_1"
